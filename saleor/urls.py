...
urlpatterns = [
    ...
    url(r'^shippingNote/', include('saleor.shippingNote.urls', namespace='ShippingNote')),
    url(r'^philosophie/', include('saleor.philosophie.urls', namespace='Philosophie')),
    url(r'^confidentialite/', include('saleor.confidentialite.urls', namespace='Confidentialite')),
    url(r'^contact/', include('saleor.contact.urls', namespace='contact')),
    url(r'^contrefacon/', include('saleor.contrefacon.urls', namespace='contrefacon'))
